            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="{{url('backend/AdminLTE/dist/img/person.png')}}" class="img-circle"
                                                     alt="User Image">
                                            </div>
                                            <h4>
                                                Support Team
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            @if(Auth::user())
                            <img src="{{url('backend/AdminLTE//dist/img/avatar.jpg')}}" class="user-image" alt="User Image">
                            <span class="hidden-xs">{{ Auth::user()->name }}</span>
                            @endif
                        </a>
                        <ul class="dropdown-menu">
                            <li class="user-header">
                                <img src="{{url('backend/AdminLTE/dist/img/avatar.jpg')}}" class="img-circle" alt="User Image">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="{{ route('product.import') }}"><i class="fa fa-circle-o"></i>Import Product</a></li>
